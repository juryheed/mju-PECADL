...
# 데이터셋 경로
train_dir = 'D:\eye\eyedata\data\Training\label\dog\eye_ball\camaera\eyelidTumor_angumjongyang'
val_dir = 'D:\eye\eyedata\data\Validation\dog_val\eyelidTumor_angumjongyang_vali'
test_dir = 'D:\eye\eyedata\data\Validation\dog_val\eyelidTumor_angumjongyang_vali'
...
# 기존 모델 로드
model_path = 'eyelidTumor_angumjongyang_vit.pth'
...
# 기존 옵티마이저 상태 로드 (옵션)
optimizer_path = 'optimizer_state_eyelidTumor_angumjongyang.pth'
...
# 기존 기록 로드 (옵션)
record_path = 'training_records_eyelidTumor_angumjongyang.pth'
